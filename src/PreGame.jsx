...
function PreGame() {
            ...
            */
            ...
            class Field {
                ...
                constructor(field) {
                    ...
                    let { left, right, top, bottom } = getCoordinates(
                        this.field
                    );
                    this.fieldLeft = left;
            ...
            class Ships {
                ...
                static showShip(self, shipname, x, y, kx) {
                    ...
                    div.style.cssText = `left:${y * Field.SHIP_SIDE}px; top:${x * Field.SHIP_SIDE
                        }px;`;
            ...
            class Placement {
                ...
                setObserver() {
                    ...
                    humanfield.addEventListener(
                        "contextmenu",
                        this.rotationShip.bind(this)
                    );
                ...
                onMouseMove(e) {
                    ...
                    if (!this.clone) {
                        ...
                        this.decks = Placement.getCloneDecks(
                            this.dragObject.el
                        );
                        // создаём клон, используя ранее полученные координаты его сторон
                        this.clone =
                            this.creatClone({ left, right, top, bottom }) ||
                            null;
                ...
                creatClone() {
                    ...
                    clone.rollback = () => {
                        ...
                        if (oldPosition.parent == humanfield) {
                            ...
                            clone.style.zIndex = "";
                            oldPosition.parent.insertBefore(
                                clone,
                                oldPosition.next
                            );
                            this.createShipAfterMoving();
                ...
                getCoordsCloneInMatrix({ left, right, top, bottom }) {
                    ...
                    obj.top =
                        Math.round(ft / Field.SHIP_SIDE) * Field.SHIP_SIDE;
                    obj.left =
                        Math.round(fl / Field.SHIP_SIDE) * Field.SHIP_SIDE;
            ...
            class Controller {
                ...
                setCoordsAroundHit(x, y, coords) {
                    ...
                    if (firstHit.length == 0) {
                        ...
                        this.tempShip.kx =
                            Math.abs(firstHit[0] - x) == 1 ? 1 : 0;
                        this.tempShip.ky =
                            Math.abs(firstHit[1] - y) == 1 ? 1 : 0;
                    }
                ...
                checkUselessCell(coords) {
                    ...
                    const icons =
                        this.opponent.field.querySelectorAll(".shaded-cell");
                ...
                markUselessCell(coords) {
                    ...
                    for (let coord of coords) {
                        ...
                        if (human.matrix[x][y] == 2 || human.matrix[x][y] == 3)
                            continue;
                ...
                transformCoordsInMatrix(e, self) {
                    const x = Math.trunc(
                        (e.pageY - self.fieldTop) / Field.SHIP_SIDE
                    );
                    const y = Math.trunc(
                        (e.pageX - self.fieldLeft) / Field.SHIP_SIDE
                    );
                    return [x, y];
                }
                ...
                showIcons(opponent, [x, y], iconClass) {
                    ...
                    function fn() {
                        ...
                        span.style.cssText = `left:${y * Field.SHIP_SIDE
                            }px; top:${x * Field.SHIP_SIDE}px;`;
                ...
                showExplosion(x, y) {
                    ...
                    const explosion =
                        this.opponent.field.querySelector(".explosion");
                    ...
                    switch (v) {
                        ...
                        case 4:
                            Controller.showServiceText(
                                "По этим координатам вы уже стреляли!"
                            );
                            break;
                    }
                }
            ...
            // на игровое поле
            const initialShips = document.querySelector(
                ".wrap + .initial-ships"
            );
            ...
            buttonPlay.addEventListener("click", function (e) {
                ...
                // startGame = true;
                this.style.backgroundColor = "#0236EF";
    ...
    return (
        <div className="">
            <img className="logo_pregame" src={Logo} width="10%" height="auto" />
        {/* Move to Game.jsx */}
            <div className="Statistic_block">
                <div className="End_block Win">
                    <div className="header_stats">
                        <span className="result">Ура, Победа!</span>
                    </div>
                    <div className="stats">
                        <div className="values">
                            <span className="Stat_text">Статистика:</span>
                            <span className="name_of_value">Продолжительность партии - </span>
                            <span className="name_of_value">Потопленные корабли - </span>
                            <div className="buttons_block">
                                <button className="restart-btn ">Реванш</button>
                                <button className="exit-btn">Выйти</button>
                            </div>
                        </div>
                        <img src={win} alt="" />
                        {/* <div className="meme_img"></div> */}
                    </div>
                    
                </div>
                {/* <div className="End_block Lose">
            ...
            <div
                id='matrix'
                style={{ position: "fixed", left: "20px", top: "50px" }}>
            </div>
            <div className='wrap'>
                <div className='battlefield'>
                    ...
                    <div id='instruction' className='instruction'>
                        <div id='ships_collection' className='ships-collection'>
                            <p>
                                Перетащите мышкой корабли на ваше поле. Для
                                установки корабля по вертикали, кликните по нему
                    ...
                    <div className='service-row'>
                        ...
                        <button id='play' type='button' className='btn-play'>
                            Готов
                        </button>
                        <button
                            id='newgame'
                            type='button'
                            className='btn-play btn-newgame'
                            hidden>
                            Продолжить
                        </button>
                    </div>
                    <ul className='initial-ships'>
                        <li>
                            <div id='fourdeck1' className='ship fourdeck'></div>
                            <div
                                id='tripledeck1'
                                className='ship tripledeck tripledeck1'></div>
                            <div
                                id='tripledeck2'
                                className='ship tripledeck tripledeck2'></div>
                        </li>
                        <li>
                            <div
                                id='doubledeck1'
                                className='ship doubledeck'></div>
                            <div
                                id='doubledeck2'
                                className='ship doubledeck doubledeck2'></div>
                            <div
                                id='doubledeck3'
                                className='ship doubledeck doubledeck3'></div>
                        </li>
                        <li>
                            <div
                                id='singledeck1'
                                className='ship singledeck'></div>
                            <div
                                id='singledeck2'
                                className='ship singledeck singledeck2'></div>
                            <div
                                id='singledeck3'
                                className='ship singledeck singledeck3'></div>
                            <div
                                id='singledeck4'
                                className='ship singledeck singledeck4'></div>
                        </li>
                    </ul>
                </div>
            </div>
