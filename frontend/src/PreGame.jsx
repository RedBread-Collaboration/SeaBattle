...
import winMeme from "./media/win.png";
import loseMeme from "./media/lose.png";
...
function PreGame() {
  useEffect(() => {
    (function () {
      ...
      const humanfield = getElement("field_human1");
      const computerfield = getElement("field_human2");
      ...
      class Controller {
        ...
        init() {
          ...
          if (this.player === human) {
            ...
            compShot = true;
            this.text = "Первым стреляет Соперник";
        ...
        makeShot(e, coords) {
          ...
          if (e !== undefined) {
            ...
            // var username1 = cookies.get("username");
            // console.log(username1);
            // xhr.open(
            //     "GET",
            //     `http://127.0.0.1:8000/game/${username1}`,
            //     true
            // );
            // xhr.send();
            // console.log(xhr.responseText);
            // var username2 = xhr.response["username_2"];
            // console.log(username2);
            // if (username2 === username1) {
            //     username2 = xhr.response["username_1"];
            // }
            // sendMsg("Syr", { x: x, y: y });
        ...
        miss(x, y) {
          ...
          if (this.player === human) {
            text = "Вы промахнулись. Стреляет Соперник.";
            this.player = computer;
            this.opponent = human;
            compShot = true;
            setTimeout(() => this.makeShot(), 2000);
          } else {
            text = "Соперник промахнулся. Ваш выстрел.";
        ...
        hit(x, y) {
          ...
          text =
            this.player === human
              ...
              : "Соперник попал в ваш корабль. Выстрел Соперника";
          setTimeout(() => Controller.showServiceText(text), 400);
        ...
        <div className="battlefield">
          ...
          <div className="flex outer">
            <div className="field field-human">
              <div id="field_human1" className="ships"></div>
            </div>

            <div className="field field-computer" hidden>
              <div id="field_human2" className="ships"></div>
            </div>

            <div id="instruction" className="instruction">
              <div id="type_placement" className="type-placement-box">
                1.{" "}
                <span className="link" data-target="random">
                  Случайным образом
                </span>
                <br />
                2.{" "}
                <span className="link" data-target="manually">
          ...
          <div className="service-row">
            ...
            <img alt="" id="meme" hidden />
            <button id="play" type="button" className="btn-play" hidden>
              Играть
            </button>
            <button
              id="newgame"
